 ...
 * @version $Id: ExpAB_TC2.java,v 1.1.1.1 2002/06/28 07:36:16 waleed Exp $
 */
...
class ABClassifier {
    AdaBoostM1 dt; 
    String name = "AdaBoost"; 
    String description = "AdaBoost Classifier"; 
    public ABClassifier(AdaBoostM1 dt){
        this.dt = dt; 
    } 
